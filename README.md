...
├── poster/                  # Poster image to augment 
├── results/                 # Final augmented images 
├── wrapped_poster/          # Warped poster images 
├── inverse_mask/            # Binary masks for blending 
├── background/              # Backgrounds after masking 
└── foreground/              # Foreground poster regions
